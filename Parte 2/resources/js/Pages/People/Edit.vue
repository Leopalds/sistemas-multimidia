    ...
    <AppLayout>
        ...
        <div class="max-w-2xl mx-auto p-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h1 class="text-2xl font-bold text-gray-900 mb-6">Editar Pessoa</h1>
...
const form = useForm({
    ...
    thumbnail_path: props.person.thumbnail_path || '',
})

const submitForm = () => {
    processing.value = true
    
    form.put(route('people.update', { person: props.person.id }), {
        onSuccess: () => {
